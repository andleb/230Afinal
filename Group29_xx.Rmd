...
tbl1format %>% select(8, 2:6) %>%
  knitr::kable(toprule = '', bottomrule = '', booktabs = TRUE, linesep = c("", "\\addlinespace"),
             ...
             caption = cat('Main specification for the cross-country analysis.",
             Italics indicate significance at the 1\\% level.')) %>%
...
tbl2aformat %>% 
  ...
  knitr::kable(toprule = '', bottomrule = '', booktabs = TRUE, linesep = c("", "\\addlinespace"),
             ...
             row.names = F,
             align = "r", escape = F,
             caption = cat('Table 2A—Robustness Checks for the Cross-Country Analysis.,
                           "Italics indicate significance at the 1\\% level.'))  %>%
...
tbl2bformat %>% 
  ...
  knitr::kable(toprule = '', bottomrule = '', booktabs = TRUE, linesep = c("", "\\addlinespace"),
             ...
             row.names = F,
             align = "r", escape = F,
             caption = cat('Table 2B—Linguistic Fractionalization across Countries.",
                           "Italics indicate significance at the 1\\% level.'))  %>%
...
tbl2binfo %>% 
  knitr::kable(toprule = '', bottomrule = '', booktabs = TRUE,
               ...
               escape = F,
               row.names = F,
               caption = cat("Information for each model in Table 2B:",
...
tbl4format %>% select(10, 2:8) %>%
  knitr::kable(toprule = '', bottomrule = '', booktabs = TRUE, linesep = c("", "\\addlinespace"),
             col.names = col.names, align = "r", escape = F,
             caption = cat('Main specification for the virtual country analysis.",
                           "Italics indicate significance at the 1\\% level.')) %>%
  row_spec(seq(2, 28, 2), font_size = 8)
```
...
tbl5aformat %>% 
  ...
  knitr::kable(toprule = '', bottomrule = '', booktabs = TRUE, linesep = c("", "\\addlinespace"),
             ...
             row.names = F,
             align = "r", escape = F,
             caption = cat("Table 5A—Robustness Checks for the Virtual Country Analysis.", 
                           "Italics indicate significance at the 1\\% level."))  %>%
...
tbl5bformat %>% 
  ...
  knitr::kable(toprule = '', bottomrule = '', booktabs = TRUE, linesep = c("", "\\addlinespace"),
             ...
             row.names = F,
             align = "r", escape = F,
             caption = cat("Table 5B—Robustness Checks for the Virtual Country Analysis.", 
                           "Italics indicate significance at the 1\\% level."))  %>%
