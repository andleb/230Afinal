...
Fortunately, the data provided by the author was already processed and cleaned to the extent used in the paper. 
All we did was rename columns to more descriptive names.
...
As mentioned, measures of variability within an aggregation are also included as features. Additional covariates are the log of the country's 1995 population,
human migration distance from Africa, and distance from a large body of water.
