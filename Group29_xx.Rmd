...
Finally, the author includes five dummy variables in the last regression that map to the continent the country is located
...
variations in climatic and soil suitability, respectively. 
...
*ELF - Etnolinguistic fractionalization*.  This is taken from an updated version of an old Soviet work - *Atlas Narodov
Mira* (Atlas of the World's Nations). 

In columns 4-7, the same metric is reconstructed from the *Ethnologue* dataset using splitting rules of increasing fineness
for constructed language trees.

It also substitutes the measures of land suitability discussed above with their climatic counterpart, used in the previous
robustness check.
...
The noticeably small values of $R^2$ across the models indicate that ...
