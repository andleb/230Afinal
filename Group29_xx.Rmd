...
```{r codeAppendix, ref.label=c('data_import', 'rename', 'greeceNepal', 'worldMap', 'summary', 'standardize', 'model2', 'model1.1Rob', 'model1.2Rob', 'model1.3Rob', 'model1.4Rob'), echo=T, eval=F}
