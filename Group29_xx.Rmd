...
# TODO: continental FE? Assuming africa etc dummies
# NOTE: coeffs much closer if not standardizing
# Why do I have more observations?
robust1.1 <- glm.nb(exp(lnLang) ~ sdElev + sdSuitable + africa + europe + americas + reg_eap
...
# TODO: continental FE?
# data2 <- read.dta13("data_raw/.dta")
robust1.2 <- lm(lnLang ~ dispElev + dispSuitable + africa + europe + americas + reg_eap,
                    data, na.action = na.exclude)
