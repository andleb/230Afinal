...
for (model in models) {
  ...
  tbl5bformat[estimRows, model] <- sprintf(fmt = "%.3f", tbl5bformat[estimRows, model] %>% unlist() %>% as.numeric())
  ...
  tbl5bformat[estimRows, model] <- cell_spec(tbl5bformat[estimRows, model], italic = significant[estimRows])
  tbl5bformat[seRows, model] <- cell_spec(tbl5bformat[seRows, model], italic = significant[seRows])
}
