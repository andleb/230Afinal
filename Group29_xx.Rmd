...
#TODO: calculate cluster-robust by hand?
#     GEE


# NOTE: seems unstandardized
robust2.1 <-  glm.nb(numLang ~ absLat + sdElev + sdSuitable +  avgElev + avgSuitable +  avgPrecip +  avgTemp +  lnArea +  seaDist + 
...
robust2.1geem <- geem(formula = numLang ~ absLat + sdElev + sdSuitable +  avgElev + avgSuitable +  avgPrecip +
                    ...
                    family = MASS::negative.binomial(theta = robust2.1$theta, link = 'log'),
                    sandwich = TRUE,
                    corstr = "independence",
                    scale.fix = TRUE,
                    init.phi = robust2.1$theta
                    )
```
...
`TODO: check if fixed effect OK`

```{r model2.2Rob, results='hide', echo=F, eval=F}
robust2.2 <- lm_robust(lnLang ~ absLat + sdElev + sdSuitable + avgElev + avgSuitable +  avgPrecip + avgTemp +  lnArea + 
...
```{r model2.2RobTable, results='show', echo=F, eval=F}
summary(robust2.2)
```

OK

```{r model2.3Rob, results='hide', echo=F, eval=F}
robust2.3 <- lm_robust(lnLang ~ absLat + sdElev + sdSuitable + avgElev + avgSuitable +  avgPrecip + avgTemp +  lnArea + 
                       seaDist + waterArea +  withinCountry +  numCountry +  migrationDist +  lnPopDens95,
...
```{r model2.3RobTable, results='show', echo=F, eval=F}
summary(robust2.3)
```
...
```{r model2.4Rob, results='hide', echo=F, eval=F}
#FIXME: what's the difference between 3 & 4?
robust2.4 <- lm_robust(lnLang ~ absLat + sdElev + sdSuitable + avgElev + avgSuitable +  avgPrecip + avgTemp +  lnArea + 
                       seaDist + waterArea +  withinCountry +  numCountry +  migrationDist +  lnPopDens95,
                      data2 %>% filter((data2$suitableCells >= 10) & (data2$totalPop95 >= 50000)),
                      fixed_effects = ~countryCode,
                      se_type = "stata")
...
```{r model2.4RobTable, results='show', echo=F, eval=F}
summary(robust2.4)
```


```{r model2.5Rob, results='hide', echo=F, eval=F}
robust2.5 <- lm_robust(lnLang ~ absLat + sdElev + sdSuitable + avgElev + avgSuitable +  avgPrecip + avgTemp +  lnArea + 
                       seaDist + waterArea +  withinCountry +  numCountry +  migrationDist +  lnPopDens95,
                      data2 %>% filter((data2$suitableCells >= 10) & (data2$totalPop95 >= 50000)),
                      fixed_effects = ~countryCode,
                      se_type = "stata")
...
```{r model2.5RobTable, results='show', echo=F, eval=F}
summary(robust2.5)
```
