...
robust2.1.1 <-  glm.nb(numLang ~ absLat + sdElev + sdSuitable +  avgElev + avgSuitable +  avgPrecip +  avgTemp +  lnArea +  seaDist + 
...
robust2.1.1geem <- geem(formula = numLang ~ absLat + sdElev + sdSuitable +  avgElev + avgSuitable +  avgPrecip +
                        ...
                        family = MASS::negative.binomial(theta = robust2.1.1$theta, link = 'log'),
                        sandwich = TRUE,
                        corstr = "independence",
                        scale.fix = TRUE,
                        init.phi = robust2.1.1$theta
                        )
```

```{r model2.1.1RobTable, results='show', echo=F, eval=T}
summary(robust2.1.1geem)
```
...
```{r model2.1.2RobTable, results='show', echo=F, eval=T}
summary(robust2.1.2)
```
...
```{r model2.1.3RobTable, results='show', echo=F, eval=T}
summary(robust2.1.3)
```
